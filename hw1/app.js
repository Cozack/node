...
//
// fs.mkdir(path1800,{recursive:true},(err) => {console.log(err)})
// fs.mkdir(allFiles,{recursive:true},(err) => {console.log(err)})
// fs.mkdir(path2000,{recursive:true},(err) => {console.log(err)})
...
//
// fs.writeFile(firstUser,JSON.stringify({name:'Oleg',gender:'male'}),(err) => {console.log(err)})
// fs.writeFile(secondUser,JSON.stringify({name:'Katya',gender:'female'}),(err) => {console.log(err)})
// fs.writeFile(thirdUser,JSON.stringify({name:'Vitya',gender:'male'}),(err) => {console.log(err)})
//
...
//
//
// fs.writeFile(fourthUser,JSON.stringify({name:'Inna',gender:'female'}),(err) => {console.log(err)})
// fs.writeFile(fiveUser,JSON.stringify({name:'Olga',gender:'female'}),(err) => {console.log(err)})
// fs.writeFile(sixUser,JSON.stringify({name:'Yura',gender:'male'}),(err) => {console.log(err)})
